...
<?php
  ...
  if(isset($_POST['btnUpdate'])){
                        ...
                        $db->query("UPDATE user SET name = '$name', email = '$email' WHERE username = '$username2'");
            ...
            <tr>
                <td align="center" class="auto-style3">
                 ...
                 <td class="auto-style3">
                     <input name="btnUpdate" type="submit" value="Update" ID="btnUpdate" BorderColor="#333399" BorderStyle="Ridge"/> 
                 </td>
            </tr>
             <tr>
                <td align="center" colspan="2">
